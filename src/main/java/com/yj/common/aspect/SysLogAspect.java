...
import com.yj.sys.common.util.IPUtils;
...
public class SysLogAspect {
	...
	/**
	 * @Pointcut注解用于定义切入点
	 * bean表达式内部制定的bean对象中所有方法为切入点(进行功能扩展的点)
	 * */
	@Pointcut("@annotation(com.yj.common.annotation.RequiredLog)")
	...
	@Transactional
	 ...
	 private void saveObject(ProceedingJoinPoint jp,long time)throws Exception {
		 ...
		 if(user==null) throw new UnknownAccountException("请登录后再操作");
